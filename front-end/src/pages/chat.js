        ...
        <div className="container mt-4 ">
            <div className="row chat-window" id="chat_window_1" >
                <div className="col-xs-4 col-md-4">
                        ...
                        <ul>
                            {
                                users.map((e, i) => (
                                    <div className='userList'>
                                        <img className='userimg' src='https://png.pngtree.com/png-vector/20191110/ourmid/pngtree-avatar-icon-profile-icon-member-login-vector-isolated-png-image_1978396.jpg' alt="userImg"/>
                                        <li key={i}>{e.user}</li>
                                    </div>
                    ...
                    <div>
                        <button className='exit-button' onClick={() => navigate("/")} type='button'>Exit</button>
                    </div>
